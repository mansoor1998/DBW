...
import {LOGOUT_USER} from "../redux/reducers";
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      {/* <img
                        ...
                        alt="Workflow"
                      /> */}
                      <h1 className="h-8 w-8 text-white text-xl mt-3">DBW</h1>
                    </div>
                        ...
                        >
                          <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                            {userNavigation.map((item) => (
                              <Menu.Item key={item.name} onClick={() => item.name==='Sign out' && dispatch(LOGOUT_USER())}>
                                {({ active }) => (
                                  <a
                                    href={item.href}
                                    className={classNames(
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                      <div className="text-base font-medium leading-none text-white">{user.user_id}</div>
                  ...
                  <div className="mt-3 px-2 space-y-1">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        ...
                        as="a"
                        href={item.href}
                        onClick={() => item.name==='Sign out' && dispatch(LOGOUT_USER())}s
